...
<div>
	<main>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 44" class="w-40">
			<path
				fill="currentColor"
		...
		<Button on:click={getSentryData}>Throw error!</Button>

		<p>
			2. Look for the error on the
			<a href="https://brandon-ting.sentry.io/issues/?project=4508754157240400">Issues Page</a>.
		</p>
